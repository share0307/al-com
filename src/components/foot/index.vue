 ...
 * @Last Modified by: 
 * @Last Modified time: 2018-12-05 15:41:06
 * @description：底部导航
 */
...
<template>
    <section id='foot_guide'>
        ...
        <section @click = "gotoAddress({path: '/homefish', query: {geohash}})" class="guide_item">
        	<svg class="icon_style">
                <use xmlns:xlink="http://www.w3.org/1999/xlink" :xlink:href="$route.path.indexOf('homefish') !== -1? '#msiteActive' : '#msite'"></use>
            </svg>
            <span>外卖</span>
        </section>
        ...
        <section @click = "gotoAddress('/login')" class="guide_item">
        	<svg class="icon_style">
                <use xmlns:xlink="http://www.w3.org/1999/xlink" :xlink:href="$route.path.indexOf('login') !== -1? '#orderActive' : '#order'"></use>
            </svg>
            <span>订单</span>
        </section>
        <section @click = "gotoAddress('/center')" class="guide_item">
        	<svg class="icon_style">
                <use xmlns:xlink="http://www.w3.org/1999/xlink" :xlink:href="$route.path.indexOf('center') !== -1? '#profileActive' : '#profile'"></use>
            </svg>
            <span>我的</span>
        </section>
    </section>
