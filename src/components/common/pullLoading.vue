 <template>
	<div class="loading_container">
	    <div class="load_img" :style="{backgroundPositionY: -(positionY%7)*66 + 'px'}">
	    </div>
...
.load_img {
  @include wh(100%, 100%);
  background: url(../../assets/images/common/icon_loading.png) no-repeat 0 0;
